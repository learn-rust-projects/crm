...
pub enum ContentType {
    ...
    Unspecified = 0,
    /// Short-form content (e.g., clips under 60s)
    Short = 1,
    /// Video blog content
    Vlog = 2,
...
pub mod metadata_client {
    ...
    /// Metadata service for content materialization
    /// Handles streaming RPC for fetching and streaming content metadata
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Materialize content by streaming content IDs
        /// Takes a stream of content IDs and returns a stream of matching
        /// Content objects
