...
#[derive(sqlx::FromRow, derive_builder::Builder, Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct User {
    #[prost(string, tag = "1")]
    #[builder(setter(into))]
...
#[derive(derive_builder::Builder, Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RawQueryRequest {
    #[prost(string, tag = "1")]
    #[builder(setter(into))]
    pub query: ::prost::alloc::string::String,
}
#[derive(derive_builder::Builder, Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
